...
localtime_internal_total = sum(v["localtime_sum_internal"] for k,v in functiondict.items())
localtime_overhead_total = sum(v["localtime_sum_overhead"] for k,v in functiondict.items())
